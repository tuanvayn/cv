			...
			prj: [
				{
					...
					skills: ['Java', 'Struts', 'Spring', 'SOAP', 'REST', 'JSP', 'Git', 'Jira'],
...
- Led a 3 members team, developed new features and maintained old features for the client's services using Java and related technologies, such as Spring, Struts, Hibernate and utilized SQL Server for database management
`
				}
			]
		},
			...
			prj: [
				{
					...
					role: "Team lead",
					contents: `
Worked as an outsourced Java developer re-built Vietinbank business customer banking service to microservices

- Collaborated with the in-house development team to understand project requirements and design specifications

- Led a team with 12 members, developed microservices for the banking service using Java and related technologies, such as Spring Boot, Hibernate and Docker, Kubernetes
`
				},
				{
					...
					role: "Team lead",
					contents: `
Worked as an outsourced Java developer built Vietinbank system which supports connections from other systems like Misa ERP, Grab, etc...

- Collaborated with the in-house development team to understand project requirements and design specifications

- Led a team with 4 members, developed application using Java and related technologies, such as Spring and Hibernate.
`
				},
				{
...
- Attented to develop services in the system for managing population data using Spring Boot
